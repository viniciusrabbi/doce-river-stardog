...
public class FileConverter {
	 ...
	 public static final IRI rio_doce_iri = IRI
	            .create("C:\\Users\\Vinicius\\Desktop\\model.owl");
    ...
    public String convertGoopToOWL(List<Map<String, String>> classes, List<Map<String, String>> properties) {
        ...
        try {
            ...
            File fileformated = new File("C:/Users/Vinicius/Documents/tempConverted.rdf");
            manager.saveOntology(ontologiaAlvo, IRI.create(fileformated.toURI()));

            byte[] encoded = Files.readAllBytes(Paths.get("C:/Users/Vinicius/Documents/tempConverted.rdf"));
    ...
    public static void testSaveOntology() throws Exception {
        OWLOntologyManager m = OWLManager.createOWLOntologyManager();
        OWLOntology o = m.getOntology(rio_doce_iri);
        //assertNotNull(o);
